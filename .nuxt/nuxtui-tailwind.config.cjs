      ...
      const { customSafelistExtractor, generateSafelist } = require("/home/cheese/Development/ollo-v3/node_modules/@nuxt/ui/dist/runtime/utils/colors")
      ...
      module.exports = {
        ...
        content: {
          files: [
            "/home/cheese/Development/ollo-v3/node_modules/@nuxt/ui/dist/runtime/components/**/*.{vue,mjs,ts}",
            "/home/cheese/Development/ollo-v3/node_modules/@nuxt/ui/dist/runtime/ui.config/**/*.{mjs,js,ts}"
          ],
          transform: {
            vue: (content) => {
